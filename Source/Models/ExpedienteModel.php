...
/**
 * A classe ExpedienteModel é responsável por representar um escalação no sistema
 * 
 * @version ${1:2.1.0
...
class ExpedienteModel extends Model
{
     ...
     * @var string
     */
    private static $entity = "expediente";
    /**
     ...
     * @var string
     */
    private static $id = "Funcionario_idFuncionario";
    /**
     ...
     * @var string
     */
    private static $idUnit = "Plantao_idUnidade";
    /**
     ...
     * @var string
     */
    private static $idDepartment = "Plantao_idDepartamento";
    /**
     ...
     * @var string
     */
    private static $idScale = "Plantao_idEscala";
    /**
     * A variável foi criada com o objetivo de armazenar o nome do id da Plantão 
     * na tabela do banco, para assim, facilitar a construção e replicação do código.
     * 
     * @var string
     */
    private static $idDuty = "Plantao_idPlantao";

    /**
     * Insere ou atualiza um registro no banco de dados.
     * 
     * @return ExpedienteModel|null Um objeto ExpedienteModel, ou null caso tenha uma falha na criação ou atualização do registro.
     */
    public function save(): ?ExpedienteModel
    {
        ...
        if (empty($this->data->idExpediente)) {
            ...
            $idExpediente = $this->create($query, $params);
            ...
            if ($idExpediente) {
                $this->data->idExpediente = $idExpediente;
    ...
    public function destroy(): ?bool
    {
        ...
        // Define os parâmetros da query
        $params = ":" . self::$id . "={$this->data->idExpediente}";
        ...
        if ($this->delete($sql, $params)) {
            $this->data = null;
            $this->message = "Expediente deletado com sucesso!";
        } else {
            $this->message = "Ooops algo deu errado!";
            return null;
        }
     ...
     *
     * @return array|null Um array de objetos ExpedienteModel, ou null caso não haja registros na tabela.
     */
    public function all(): ?array
    {
        ...
        if(!$stmt->rowCount()){
            $this->message = "Nenhum expediente foi encontrado!";
            return null;
        }
     ...
     * @return ExpedienteModel|null Um array de objetos ExpedienteModel, ou null caso não haja registros na tabela.
     */
    public function findById(int $id): ?ExpedienteModel
    {
    ...
    private function required(): ?bool
    {
        ...
        if (empty($this->data->idFuncionario) || empty($this->data->idPlantao) || empty($this->data->idUnidade) || empty($this->data->idDepartamento) || empty($this->data->idEscala)) {
    ...
    public function findByIdUnit(int $idUnit_param): ?array
    {
        ...
        if (!$findByIdUnit->rowCount()) {
            $this->message = "Nenhuma Unidade foi encontrada relacionada a essa expediente!";
            return null;
        }
    ...
    public function findByIdDepartment(int $idDepartment_param): ?array
    {
        ...
        if (!$findByIdDepartment->rowCount()) {
            $this->message = "Nenhum Departamento foi encontrada relacionado a esse expediente!";
            return null;
        }
    ...
    public function findByIdScale(int $idScale_param): ?array
    {
        ...
        if (!$findByScale->rowCount()) {
            $this->message = "Nenhuma Escala foi encontrada relacionada a essa expediente!";
            return null;
        }
    ...
    public function findByEmployee(int $idEmployee_param): ?array
    {
        ...
        if (!$findByEmployee->rowCount()) {
            $this->message = "Nenhum Funcionário foi encontrada relacionada a essa expediente!";
            return null;
        }
