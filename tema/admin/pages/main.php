                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                <div class="inner">
                                    ...
                                    ?>
                                    <p><br>DepartamentosㅤㅤㅤㅤInseridos<br></p>
                                </div>
                                <div class="icon">
                                    <i class="fas fa-stethoscope"></i>
                                </div>
                                <a href="index.php?c=departamento&a=visualizar" class="small-box-footer">More info <i
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                <div class="inner">
                                    ...
                                    <p><br>RelatóriosㅤㅤㅤㅤDetalhados<br></p>
                                </div>
                                <div class="icon">
                                    <i class="fas fa-file-medical"></i>
                                </div>
                                <a href="index.php?c=relatorio&a=visualizar" class="small-box-footer">More info <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    ...
                                    ?>
                                    <p>ㅤ<br>Funcionarios Cadastrados</p>
                                </div>
                                <div class="icon">
                                    <i class="fas fa-user-md"></i>
                                </div>
                                <a href="index.php?c=funcionario&a=visualizar" class="small-box-footer">More info <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-danger">
                                <div class="inner">
                                    ...
                                    ?>
                                    <p><br>ㅤ<br>Escalas do Dia</p>
                                </div>
                                <div class="icon">
                                <i class="fas fa-calendar-alt"></i>
                                </div>
                                <a href="index.php?c=escala&a=visualizar" class="small-box-footer">More info <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
